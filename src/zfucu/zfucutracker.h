...
#ifndef FUCUCOIN_ZFUCUTRACKER_H
#define FUCUCOIN_ZFUCUTRACKER_H
...
public:
    CzFUCUTracker(CWallet* parent);
    ~CzFUCUTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzFUCUWallet* zFUCUWallet = NULL);
