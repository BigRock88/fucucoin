...
#ifndef FUCUCOIN_ZFUCUWALLET_H
#define FUCUCOIN_ZFUCUWALLET_H
...
public:
    ...
    void GenerateDeterministicZFUCU(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZFUCU(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
