...
#ifndef FUCUCOIN_LEGACY_ZPOS_H
#define FUCUCOIN_LEGACY_ZPOS_H

#include "stakeinput.h"
#include "main.h"
#include "txdb.h"

class CLegacyZFucuStake : public CStakeInput
{
private:
    uint32_t nChecksum;
...
public:
    ...
    explicit CLegacyZFucuStake(const libzerocoin::CoinSpend& spend);
    bool InitFromTxIn(const CTxIn& txin) override;
    bool IsZFUCU() const override { return true; }
