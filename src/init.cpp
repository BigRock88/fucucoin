...
void PrepareShutdown()
{
    ...
    util::ThreadRename("fucucoin-shutoff");
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-masternodeaddr=<n>", strprintf(_("Set external address:port to get to this masternode (example: %s)"), "128.127.106.235:19660"));
...
{
    util::ThreadRename("fucucoin-loadblk");
