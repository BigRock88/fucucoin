...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\fucucoin
// Windows >= Vista: C:\Users\Username\AppData\Roaming\fucucoin
// Mac: ~/Library/Application Support/fucucoin
// Unix: ~/.fucucoin
#ifdef WIN32
    // Windows
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty fucucoin.conf if it does not exist
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override fucucoin.conf
