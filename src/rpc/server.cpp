...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FUCU features */
        {"fucucoin", "listmasternodes", &listmasternodes, true },
        {"fucucoin", "getmasternodecount", &getmasternodecount, true },
        {"fucucoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"fucucoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"fucucoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"fucucoin", "masternodecurrent", &masternodecurrent, true },
        {"fucucoin", "startmasternode", &startmasternode, true },
        {"fucucoin", "createmasternodekey", &createmasternodekey, true },
        {"fucucoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"fucucoin", "listmasternodeconf", &listmasternodeconf, true },
        {"fucucoin", "getmasternodestatus", &getmasternodestatus, true },
        {"fucucoin", "getmasternodewinners", &getmasternodewinners, true },
        {"fucucoin", "getmasternodescores", &getmasternodescores, true },
        {"fucucoin", "preparebudget", &preparebudget, true },
        {"fucucoin", "submitbudget", &submitbudget, true },
        {"fucucoin", "mnbudgetvote", &mnbudgetvote, true },
        {"fucucoin", "getbudgetvotes", &getbudgetvotes, true },
        {"fucucoin", "getnextsuperblock", &getnextsuperblock, true },
        {"fucucoin", "getbudgetprojection", &getbudgetprojection, true },
        {"fucucoin", "getbudgetinfo", &getbudgetinfo, true },
        {"fucucoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"fucucoin", "mnfinalbudget", &mnfinalbudget, true },
        {"fucucoin", "checkbudgets", &checkbudgets, true },
        {"fucucoin", "mnsync", &mnsync, true },
        {"fucucoin", "spork", &spork, true },
...
{
    return "> fucucoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:28888/\n";
}
