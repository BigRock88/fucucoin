/* src/config/fucucoin-config.h.  Generated from fucucoin-config.h.in by configure.  */
/* src/config/fucucoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef FUCU_CONFIG_H

#define FUCU_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/fucucoin910/fucucoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "FUCU Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "FUCU Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fucucoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://www.fucucoin.org"
