...
public:
    ...
    QLabel *wallet_customzbibbackuppath_label;
    QLabel *wallet_customzbibbackuppath;
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        wallet_customzbibbackuppath_label = new QLabel(tab_repair);
        wallet_customzbibbackuppath_label->setObjectName(QStringLiteral("wallet_customzbibbackuppath_label"));
        wallet_customzbibbackuppath_label->setVisible(false);

        gridLayout_4->addWidget(wallet_customzbibbackuppath_label, 4, 0, 1, 1);

        wallet_customzbibbackuppath = new QLabel(tab_repair);
        wallet_customzbibbackuppath->setObjectName(QStringLiteral("wallet_customzbibbackuppath"));
        wallet_customzbibbackuppath->setCursor(QCursor(Qt::IBeamCursor));
        wallet_customzbibbackuppath->setVisible(false);
        wallet_customzbibbackuppath->setTextFormat(Qt::PlainText);
        wallet_customzbibbackuppath->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        gridLayout_4->addWidget(wallet_customzbibbackuppath, 4, 1, 1, 3);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the FUCU debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        wallet_customzbibbackuppath_label->setText(QApplication::translate("RPCConsole", "Custom zFUCU Backup Path:", Q_NULLPTR));
        wallet_customzbibbackuppath->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
