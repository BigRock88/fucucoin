...
"             }"));
    ...
    void retranslateUi(QWidget *send)
    {
        ...
        labelSubtitle1->setText(QApplication::translate("send", "Send public coins (FUCU)", Q_NULLPTR));
        labelSubtitleAddress->setText(QApplication::translate("send", "FUCU address or contact label", Q_NULLPTR));
