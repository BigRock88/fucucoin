...
#include "qt/fucucoin/optionbutton.h"
...
public:
    ...
    void setupUi(QWidget *MasterNodesWidget)
    {
        ...
        pushButtonStartAll->setObjectName(QStringLiteral("pushButtonStartAll"));
        ...
        pushButtonStartMissing->setObjectName(QStringLiteral("pushButtonStartMissing"));
    ...
    void retranslateUi(QWidget *MasterNodesWidget)
    {
        ...
        labelTitle->setText(QApplication::translate("MasterNodesWidget", "Masternodes", Q_NULLPTR));
        labelSubtitle1->setText(QApplication::translate("MasterNodesWidget", "Full nodes that incentivize node operators to perform the core consensus functions\n"
"and vote on the treasury system receiving a periodic reward.", Q_NULLPTR));
        ...
        pushButtonSave->setText(QApplication::translate("MasterNodesWidget", "Create Masternode Controller", Q_NULLPTR));
        pushButtonStartAll->setText(QApplication::translate("MasterNodesWidget", "Start All", Q_NULLPTR));
        pushButtonStartMissing->setText(QApplication::translate("MasterNodesWidget", "Start Inactive/s", Q_NULLPTR));
    } // retranslateUi
