...
public:
    ...
    void retranslateUi(QWidget *AddNewAddressDialog)
    {
        ...
        labelTitle->setText(QApplication::translate("AddNewAddressDialog", "New Address", Q_NULLPTR));
        labelQrImg->setText(QString());
        labelAddress->setText(QApplication::translate("AddNewAddressDialog", "Address", Q_NULLPTR));
        ...
        btnSave->setText(QApplication::translate("AddNewAddressDialog", "SAVE", Q_NULLPTR));
    } // retranslateUi
