...
"}"));
    ...
    void retranslateUi(QWidget *NavMenuWidget)
    {
        ...
        btnDashboard->setText(QApplication::translate("NavMenuWidget", "HOME\n"
"", Q_NULLPTR));
        btnSend->setText(QApplication::translate("NavMenuWidget", "SEND\n"
"", Q_NULLPTR));
        btnReceive->setText(QApplication::translate("NavMenuWidget", "RECEIVE\n"
"", Q_NULLPTR));
        btnAddress->setText(QApplication::translate("NavMenuWidget", "CONTACTS\n"
"", Q_NULLPTR));
        btnMaster->setText(QApplication::translate("NavMenuWidget", "MASTER\n"
"NODES", Q_NULLPTR));
        btnSettings->setText(QApplication::translate("NavMenuWidget", "SETTINGS\n"
"", Q_NULLPTR));
