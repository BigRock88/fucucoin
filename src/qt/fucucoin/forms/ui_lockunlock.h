...
public:
    ...
    void retranslateUi(QWidget *LockUnlock)
    {
        ...
        pushButtonUnlocked->setText(QApplication::translate("LockUnlock", "Unlock Wallet", Q_NULLPTR));
        pushButtonLocked->setText(QApplication::translate("LockUnlock", "Lock Wallet", Q_NULLPTR));
        pushButtonStaking->setText(QApplication::translate("LockUnlock", "Staking Only", Q_NULLPTR));
    } // retranslateUi
