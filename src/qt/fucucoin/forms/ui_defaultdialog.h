...
public:
    ...
    void setupUi(QWidget *DefaultDialog)
    {
        ...
        labelTitle->setText(QStringLiteral("Dialog Title"));
        ...
        labelMessage->setText(QStringLiteral("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."));
    ...
    void retranslateUi(QWidget *DefaultDialog)
    {
        ...
        btnSave->setText(QApplication::translate("DefaultDialog", "OK", Q_NULLPTR));
    } // retranslateUi
