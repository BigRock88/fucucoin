...
public:
    ...
    void setupUi(QWidget *DashboardWidget)
    {
        ...
        labelAmountBib = new QLabel(right);
        labelAmountBib->setObjectName(QStringLiteral("labelAmountBib"));
        labelAmountBib->setText(QStringLiteral("0 FUCU"));
        labelAmountBib->setAlignment(Qt::AlignCenter);

        horizontalLayout_5->addWidget(labelAmountBib);
        ...
        labelSquareBib = new QLabel(verticalWidgetChart);
        labelSquareBib->setObjectName(QStringLiteral("labelSquareBib"));
        labelSquareBib->setMinimumSize(QSize(14, 14));
        labelSquareBib->setMaximumSize(QSize(14, 14));

        horizontalLayout_4->addWidget(labelSquareBib);

        labelBib = new QLabel(verticalWidgetChart);
        labelBib->setObjectName(QStringLiteral("labelBib"));
        labelBib->setText(QStringLiteral("FUCU"));

        horizontalLayout_4->addWidget(labelBib);
...
"}"));
    ...
    void retranslateUi(QWidget *DashboardWidget)
    {
        ...
        btnHowTo->setText(QApplication::translate("DashboardWidget", "How to get FUCU", Q_NULLPTR));
        labelTitle2->setText(QApplication::translate("DashboardWidget", "Rewards Chart", Q_NULLPTR));
        labelMessage->setText(QApplication::translate("DashboardWidget", "Amount of FUCU staked.", Q_NULLPTR));
        ...
        labelSquareBib->setText(QString());
        labelSquareMNRewards->setText(QString());
        labelMNRewards->setText(QApplication::translate("DashboardWidget", "FUCU MN", Q_NULLPTR));
