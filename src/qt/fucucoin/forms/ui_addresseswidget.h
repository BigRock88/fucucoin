...
public:
    ...
    void setupUi(QWidget *AddressesWidget)
    {
        ...
        lineEditName->setPlaceholderText(QStringLiteral("e.g. John Doe"));
        ...
        lineEditAddress->setPlaceholderText(QStringLiteral("e.g. H8snwVbpCdnuk2gFiT7hVjSsZxxT57PzVY"));
    ...
    void retranslateUi(QWidget *AddressesWidget)
    {
        ...
        labelTitle->setText(QApplication::translate("AddressesWidget", "Contacts", Q_NULLPTR));
        labelSubtitle1->setText(QApplication::translate("AddressesWidget", "You can add a new one in the options menu to the side.", Q_NULLPTR));
        pushImgEmpty->setText(QString());
        labelEmpty->setText(QApplication::translate("AddressesWidget", "No contacts yet", Q_NULLPTR));
        ...
        btnSave->setText(QApplication::translate("AddressesWidget", "SAVE", Q_NULLPTR));
    } // retranslateUi
