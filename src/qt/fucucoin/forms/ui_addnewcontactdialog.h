...
public:
    ...
    void retranslateUi(QDialog *AddNewContactDialog)
    {
        ...
        labelTitle->setText(QApplication::translate("AddNewContactDialog", "Edit Contact", Q_NULLPTR));
        btnEsc->setText(QString());
        labelMessage->setText(QApplication::translate("AddNewContactDialog", "Set a label for the selected address", Q_NULLPTR));
        lineEditName->setPlaceholderText(QApplication::translate("AddNewContactDialog", "Enter a label for the address (e.g. Exchange)", Q_NULLPTR));
        btnCancel->setText(QApplication::translate("AddNewContactDialog", "CANCEL", Q_NULLPTR));
        btnOk->setText(QApplication::translate("AddNewContactDialog", "SAVE", Q_NULLPTR));
    } // retranslateUi
