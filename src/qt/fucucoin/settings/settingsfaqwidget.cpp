...
#include "qt/fucucoin/settings/settingsfaqwidget.h"
#include "qt/fucucoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
    ...
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableFUCU,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableFUCU,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableFUCU,
    ...
    connect(ui->pushButton_UnspendableFUCU, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableFUCU);});
