...
#include "qt/fucucoin/settings/settingsmultisenddialog.h"
#include "qt/fucucoin/settings/forms/ui_settingsmultisenddialog.h"
#include <QListView>
    ...
    ui(new Ui::SettingsMultisendDialog)
{
    ...
    // Address
    ui->labelSubtitleAddress->setText("FUCU address or contact label");
