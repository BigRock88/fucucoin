...
#include "qt/fucucoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/fucucoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(FUCUCOINGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the FUCU RPC console.") + "<br>" +
