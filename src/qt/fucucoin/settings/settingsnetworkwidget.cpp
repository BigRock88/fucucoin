...
#include "qt/fucucoin/settings/settingsnetworkwidget.h"
#include "qt/fucucoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/fucucoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(FUCUCOINGUI* _window, QWidget *parent) :
