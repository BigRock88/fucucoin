...
#include "qt/fucucoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/fucucoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(FUCUCOINGUI* _window, QWidget *parent) :
