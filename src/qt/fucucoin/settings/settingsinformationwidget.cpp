...
#include "qt/fucucoin/settings/forms/ui_settingsinformationwidget.h"
...
SettingsInformationWidget::SettingsInformationWidget(FUCUCOINGUI* _window,QWidget *parent) :
