...
#include "qt/fucucoin/settings/settingsbackupwallet.h"
#include "qt/fucucoin/settings/settingsexportcsv.h"
#include "qt/fucucoin/settings/settingsbittoolwidget.h"
#include "qt/fucucoin/settings/settingssignmessagewidgets.h"
#include "qt/fucucoin/settings/settingswalletrepairwidget.h"
#include "qt/fucucoin/settings/settingswalletoptionswidget.h"
#include "qt/fucucoin/settings/settingsmainoptionswidget.h"
#include "qt/fucucoin/settings/settingsdisplayoptionswidget.h"
#include "qt/fucucoin/settings/settingsmultisendwidget.h"
