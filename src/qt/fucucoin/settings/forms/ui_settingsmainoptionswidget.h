...
public:
    ...
    QSpacerItem *verticalPercentagezBib;
    QLabel *labelDivider;
    ...
    void setupUi(QWidget *SettingsMainOptionsWidget)
    {
        ...
        verticalPercentagezBib = new QSpacerItem(20, 20, QSizePolicy::Minimum, QSizePolicy::Fixed);

        verticalLayout_2->addItem(verticalPercentagezBib);
    ...
    void retranslateUi(QWidget *SettingsMainOptionsWidget)
    {
        ...
        labelTitle->setText(QApplication::translate("SettingsMainOptionsWidget", "Main", Q_NULLPTR));
        labelSubtitle1->setText(QApplication::translate("SettingsMainOptionsWidget", "Customize the main application options", Q_NULLPTR));
        pushSwitchStart->setText(QString());
        labelTitleSizeDb->setText(QApplication::translate("SettingsMainOptionsWidget", "Size of database cache", Q_NULLPTR));
        labelTitleThreads->setText(QApplication::translate("SettingsMainOptionsWidget", "Number of script verification threads", Q_NULLPTR));
        ...
        checkBoxMinTaskbar->setText(QApplication::translate("SettingsMainOptionsWidget", "Minimize to the tray instead of the taskbar", Q_NULLPTR));
        checkBoxMinClose->setText(QApplication::translate("SettingsMainOptionsWidget", "Minimize on close", Q_NULLPTR));
