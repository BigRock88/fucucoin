...
public:
    ...
    void retranslateUi(QWidget *SettingsBackupWallet)
    {
        ...
        labelTitle->setText(QApplication::translate("SettingsBackupWallet", "Backup Wallet", Q_NULLPTR));
        labelSubtitle1->setText(QApplication::translate("SettingsBackupWallet", "Keep your wallet safe by doing regular backups and storing your backup file externally.\n"
"This option creates a wallet.dat file that can be used to recover your whole balance (transactions and addresses) on another device", Q_NULLPTR));
        labelSubtitleLocation->setText(QApplication::translate("SettingsBackupWallet", "Where", Q_NULLPTR));
        pushButtonDocuments->setText(QApplication::translate("SettingsBackupWallet", "Select folder...", Q_NULLPTR));
        labelDivider->setText(QString());
        labelTitle_2->setText(QApplication::translate("SettingsBackupWallet", "Change Wallet Passphrase", Q_NULLPTR));
        labelSubtitle_2->setText(QApplication::translate("SettingsBackupWallet", "This will decrypt the whole wallet data and encrypt it back with the new passphrase.\n"
"Remember to write it down and store it safely, otherwise you might lose access to your funds", Q_NULLPTR));
        pushButtonSave_2->setText(QApplication::translate("SettingsBackupWallet", "Change Passphrase", Q_NULLPTR));
    } // retranslateUi
