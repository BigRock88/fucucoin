...
public:
    ...
    void retranslateUi(QWidget *SettingsWalletOptionsWidget)
    {
        ...
        labelTitle->setText(QApplication::translate("SettingsWalletOptionsWidget", "Wallet", Q_NULLPTR));
        labelSubtitle1->setText(QApplication::translate("SettingsWalletOptionsWidget", "Customize the internal wallet options", Q_NULLPTR));
        labelTitleStake->setText(QApplication::translate("SettingsWalletOptionsWidget", "Stake split threshold", Q_NULLPTR));
        groupBox->setTitle(QString());
        radioButtonSpend->setText(QApplication::translate("SettingsWalletOptionsWidget", "Spend unconfirmed change", Q_NULLPTR));
        labelDivider->setText(QString());
        labelTitleNetwork->setText(QApplication::translate("SettingsWalletOptionsWidget", "Network", Q_NULLPTR));
        labelSubtitleNetwork->setText(QApplication::translate("SettingsWalletOptionsWidget", "Customize the node network options", Q_NULLPTR));
        groupBox_1->setTitle(QString());
        checkBoxMap->setText(QApplication::translate("SettingsWalletOptionsWidget", "Map port using UPnP", Q_NULLPTR));
        checkBoxAllow->setText(QApplication::translate("SettingsWalletOptionsWidget", "Allow incoming connections", Q_NULLPTR));
        checkBoxConnect->setText(QApplication::translate("SettingsWalletOptionsWidget", "Connect through SOCKS5 proxy (default proxy)", Q_NULLPTR));
        labelSubtitleProxy->setText(QApplication::translate("SettingsWalletOptionsWidget", "Proxy IP", Q_NULLPTR));
        lineEditProxy->setPlaceholderText(QApplication::translate("SettingsWalletOptionsWidget", "Enter proxy IP", Q_NULLPTR));
        labelSubtitlePort->setText(QApplication::translate("SettingsWalletOptionsWidget", "Port", Q_NULLPTR));
        lineEditPort->setPlaceholderText(QApplication::translate("SettingsWalletOptionsWidget", "Enter port", Q_NULLPTR));
        ...
        pushButtonSave->setText(QApplication::translate("SettingsWalletOptionsWidget", "SAVE", Q_NULLPTR));
    } // retranslateUi
