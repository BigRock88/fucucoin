...
public:
    ...
    void retranslateUi(QWidget *SettingsWalletRepairWidget)
    {
        ...
        labelTitle->setText(QApplication::translate("SettingsWalletRepairWidget", "Wallet Repair", Q_NULLPTR));
        labelSubtitle1->setText(QApplication::translate("SettingsWalletRepairWidget", "The buttons below will restart the wallet with command-line options to repair this wallet, fix issues with corrupt blockchain files or missing/obsolete transactions", Q_NULLPTR));
        pushButtonSalvage->setText(QApplication::translate("SettingsWalletRepairWidget", "Salvage wallet", Q_NULLPTR));
        labelMessageSalvage->setText(QApplication::translate("SettingsWalletRepairWidget", "Attempt to recover private keys from a corrupt wallet.dat", Q_NULLPTR));
        pushButtonRescan->setText(QApplication::translate("SettingsWalletRepairWidget", "Rescan blockchain file", Q_NULLPTR));
        labelMessageRescan->setText(QApplication::translate("SettingsWalletRepairWidget", "Rescan the blockchain for missing wallet transactions", Q_NULLPTR));
        pushButtonRecover1->setText(QApplication::translate("SettingsWalletRepairWidget", "Recover transactions 1", Q_NULLPTR));
        labelMessageRecover1->setText(QApplication::translate("SettingsWalletRepairWidget", "Recover transactions from blockchain (keep-meta-data, e.g. account owner)", Q_NULLPTR));
        pushButtonRecover2->setText(QApplication::translate("SettingsWalletRepairWidget", "Recover transactions 2", Q_NULLPTR));
        labelMessageRecover2->setText(QApplication::translate("SettingsWalletRepairWidget", "Recover transactions from blockchain (drop meta-data)", Q_NULLPTR));
        pushButtonUpgrade->setText(QApplication::translate("SettingsWalletRepairWidget", "Upgrade wallet format", Q_NULLPTR));
        labelMessageUpgrade->setText(QApplication::translate("SettingsWalletRepairWidget", "Upgrade wallet to latest format on startup. (Note: this is NOT an update of the wallet itself)", Q_NULLPTR));
        pushButtonRebuild->setText(QApplication::translate("SettingsWalletRepairWidget", "Rebuild index", Q_NULLPTR));
        labelMessageRebuild->setText(QApplication::translate("SettingsWalletRepairWidget", "Rebuild blockchain index from current blk000???.dat files", Q_NULLPTR));
        pushButtonDelete->setText(QApplication::translate("SettingsWalletRepairWidget", "Delete local blockchain", Q_NULLPTR));
        labelMessageDelete->setText(QApplication::translate("SettingsWalletRepairWidget", "Deletes all local blockchain folders so the wallet synchronizes from scratch", Q_NULLPTR));
    } // retranslateUi
