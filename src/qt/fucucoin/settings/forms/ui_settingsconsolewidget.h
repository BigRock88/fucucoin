...
public:
    ...
    void setupUi(QWidget *SettingsConsoleWidget)
    {
        ...
        pushButtonClear->setText(QStringLiteral("-"));
    ...
    void retranslateUi(QWidget *SettingsConsoleWidget)
    {
        ...
        labelTitle->setText(QApplication::translate("SettingsConsoleWidget", "Console", Q_NULLPTR));
        pushButtonOpenDebug->setText(QApplication::translate("SettingsConsoleWidget", "Open Debug File", Q_NULLPTR));
        pushButtonCommandOptions->setText(QApplication::translate("SettingsConsoleWidget", "Command Line Options", Q_NULLPTR));
        pushButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        pushButtonClear->setToolTip(QApplication::translate("SettingsConsoleWidget", "Clear history", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
