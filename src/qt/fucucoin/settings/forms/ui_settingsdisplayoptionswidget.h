...
public:
    ...
    QHBoxLayout *horizontalPercentagezBib;
    QLabel *labelTitleUnit;
    QSpacerItem *horizontalSpacerPercentagezBib;
    QValueComboBox *comboBoxUnit;
    QHBoxLayout *horizontalDenomzBib;
    QLabel *labelTitleDigits;
    QSpacerItem *horizontalDenomzBib_1;
    ...
    void setupUi(QWidget *SettingsDisplayOptionsWidget)
    {
        ...
        horizontalPercentagezBib = new QHBoxLayout();
        horizontalPercentagezBib->setObjectName(QStringLiteral("horizontalPercentagezBib"));
        labelTitleUnit = new QLabel(left);
        labelTitleUnit->setObjectName(QStringLiteral("labelTitleUnit"));

        horizontalPercentagezBib->addWidget(labelTitleUnit);

        horizontalSpacerPercentagezBib = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalPercentagezBib->addItem(horizontalSpacerPercentagezBib);
        ...
        horizontalPercentagezBib->addWidget(comboBoxUnit);


        verticalLayout_2->addLayout(horizontalPercentagezBib);

        horizontalDenomzBib = new QHBoxLayout();
        horizontalDenomzBib->setObjectName(QStringLiteral("horizontalDenomzBib"));
        labelTitleDigits = new QLabel(left);
        labelTitleDigits->setObjectName(QStringLiteral("labelTitleDigits"));

        horizontalDenomzBib->addWidget(labelTitleDigits);

        horizontalDenomzBib_1 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalDenomzBib->addItem(horizontalDenomzBib_1);
        ...
        horizontalDenomzBib->addWidget(comboBoxDigits);


        verticalLayout_2->addLayout(horizontalDenomzBib);
