...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, FUCUCOINGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, FUCUCOINGUI* gui, double posX = 3);
