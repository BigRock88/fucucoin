...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, FUCUGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, FUCUGUI* gui, double posX = 3);
