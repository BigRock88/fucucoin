...
#include "qt/fucucoin/sendmultirow.h"
...
QT_MOC_LITERAL(15, 181, 13), // "fOnlyValidate"
QT_MOC_LITERAL(16, 195, 13) // "deleteClicked"
    ...
    "addressChanged\0fOnlyValidate\0deleteClicked"
};
...
static const uint qt_meta_data_SendMultiRow[] = {
 ...
 // slots: name, argc, parameters, tag, flags
      ...
      14,    1,   92,    2, 0x28 /* Private | MethodCloned */,
 ...
 // slots: parameters
    ...
    QMetaType::Bool, QMetaType::QString, QMetaType::Bool,    2,   15,
...
void SendMultiRow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: { bool _r = _t->addressChanged((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 9: { bool _r = _t->addressChanged((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
