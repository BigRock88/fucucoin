...
/** Utility functions used by the FUCUCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render FUCU addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZfucu = false);
...
// Parse "fucucoin:" URI into recipient object, return true on successful parsing
