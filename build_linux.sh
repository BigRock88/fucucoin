...
# Create zip file of binaries
	cp fucucoin/src/fucucoind fucucoin/src/fucucoin-cli fucucoin/src/fucucoin-tx fucucoin/src/qt/fucucoin-qt .
	zip FUCU-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip fucucoind fucucoin-cli fucucoin-tx fucucoin-qt
	rm -f fucucoind fucucoin-cli fucucoin-tx fucucoin-qt
