Contributing to FUCU Core
============================

The FUCU Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the FUCU Coreunit tests or QA tests
...
[Translation Process](https://github.com/fucucoin910/fucucoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the FUCU Core project, and is not to be
confused with overall FUCU Network Protocol consensus changes.

Whether a pull request is merged into FUCU Core rests with the project merge
...
Patches that change FUCU consensus rules are considerably more involved than
...
Where a patchset proposes to change the FUCU consensus, it must have been
...
The project leader is the release manager for each FUCU Core release.
