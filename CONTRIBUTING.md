Contributing to FUCUCOIN Core
============================

The FUCUCOIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/fucucoin-project/fucucoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the FUCUCOIN Core project, and is not to be
confused with overall FUCUCOIN Network Protocol consensus changes.

Whether a pull request is merged into FUCUCOIN Core rests with the project merge
...
Patches that change FUCUCOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the FUCUCOIN consensus, it must have been
...
The project leader is the release manager for each FUCUCOIN Core release.
