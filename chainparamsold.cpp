...
{
    const char* pszTimestamp = "From the ashes of a crypto winter FucUcoin shall rise";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256S("0x00000f96e3a68af7a446c941c51555ce3549163c2cce4f2baae7a8d27b13f6d3"))
   
; 

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1669672127, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1670360627, 2747536, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000f96e3a68af7a446c941c51555ce3549163c2cce4f2baae7a8d27b13f6d3"));
        assert(genesis.hashMerkleRoot == uint256S("0x138268f038ed03d48cc62f8b303572c6519ab55edde6846de0530d4e0fd83745"));
        ...
        consensus.mBurnAddresses = {
           { "FXXXXXXXXXXXXXXXXXXXXXXXXXXXVtkn93", 0 }
        };
...
public:
    CTestNetParams()
    {
        ...
        genesis = CreateGenesisBlock(1669672177, 728240, 0x1e0ffff0, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x0000016f0df9fb82acaedcbd2d66678c0ca77bdf37e61389fdc56ad3b9945515"));
        //assert(genesis.hashMerkleRoot == uint256S("0x138268f038ed03d48cc62f8b303572c6519ab55edde6846de0530d4e0fd83745"));
	   ...
	   // vSeeds.push_back(CDNSSeedData("tseed8", "tseed8.fucucoin.net"));
...
public:
    CRegTestParams()
    {
        ...
        genesis = CreateGenesisBlock(1669672209, 186245, 0x1e0ffff0, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x0000036481fead58ee51f6866d4f5a3c97922a9bec40988794a1b59298480752"));
        //assert(genesis.hashMerkleRoot == uint256S("0xa77c96f5e377223cabe122fb3b71a6db8fb08bac8de32d0b6a0212340d5ce65d"));
