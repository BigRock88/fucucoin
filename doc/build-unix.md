UNIX BUILD NOTES
====================
Some notes on how to build FUCU Core in Unix.

Note
---------------------
Always use absolute paths to configure and compile FUCU Core and the dependencies,
...
memory available when compiling FUCU Core. On systems with less, gcc can be
...
To build FUCU Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Security
--------
To help make your FUCU Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, FUCU Core should be built with a non-executable stack
