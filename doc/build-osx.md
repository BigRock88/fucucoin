...
-------
    ...
    ./src/fucucoind -daemon # Starts the fucucoin daemon.
    ./src/fucucoin-cli --help # Outputs a list of command-line options.
    ./src/fucucoin-cli help # Outputs a list of RPC commands when the daemon is running.
