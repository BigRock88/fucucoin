...
*Setup instructions for a gitian build of FUCU Core using a VM or physical system.*

Gitian is the deterministic build process that is used to build the FUCU
...
to the FUCU GitHub release page.
...
- [Building FUCU Core](#building-fucucoin-core)
