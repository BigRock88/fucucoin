...
Provides utilities for managing copyright headers of `The FUCU
...
Setup
---------
Configuring the github-merge tool for the FUCU repository is done in the following way:

    git config githubmerge.repository FUCU-Project/FUCU
...
A script to optimize png files in the FUCU
