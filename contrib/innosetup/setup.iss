...
#define MyAppName "FUCUCOIN Core"
#define MyAppPublisher "2022 FUCUCOIN Core Developers"
#define MyAppURL "https://fucucoin.net"
#define MyAppExeName "fucucoin-qt.exe"
#define MyAppExtraData "https://explorer.fucucoin.net/bootstraps/FUCU/bootstrap.zip"
...
DefaultDirName={autopf}\FUCUCOIN
...
OutputDir=.\output
OutputBaseFilename=FUCUCOINSetup
...
DefaultGroupName=FUCUCOIN Core
...
[Files]
Source: ".\package\fucucoin-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\FUCUCOIN\FUCUCOIN-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\FUCUCOIN\FUCUCOIN-Qt,strDataDir|{userappdata}\FUCUCOIN\}');
  Result := True;
end;
