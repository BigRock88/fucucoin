...
#define MyAppName "FUCU Core"
#define MyAppPublisher "2022 FUCU Core Developers"
...
[Registry]
Root: "HKCU"; Subkey: "Software\FUCU\FUCU-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\FUCU\FUCU-Qt,strDataDir|{userappdata}\FUCU\}');
  Result := True;
end;
