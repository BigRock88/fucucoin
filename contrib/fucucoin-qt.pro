...
RESOURCES += src/qt/fucucoin.qrc src/qt/fucucoin_locale.qrc

TRANSLATIONS += src/qt/locale/fucucoin_bg.ts \
                src/qt/locale/fucucoin_de.ts \
                src/qt/locale/fucucoin_en.ts \
                src/qt/locale/fucucoin_es.ts \
                src/qt/locale/fucucoin_fi.ts \
                src/qt/locale/fucucoin_fr.ts \
                src/qt/locale/fucucoin_it.ts \
                src/qt/locale/fucucoin_ja.ts \
                src/qt/locale/fucucoin_pl.ts \
                src/qt/locale/fucucoin_pt.ts \
                src/qt/locale/fucucoin_ru.ts \
                src/qt/locale/fucucoin_sk.ts \
                src/qt/locale/fucucoin_sv.ts \
                src/qt/locale/fucucoin_vi.ts \
                src/qt/locale/fucucoin_zh_CN.ts \
                src/qt/locale/fucucoin_zh_TW.ts
